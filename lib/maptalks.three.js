...
var ThreeLayer = function (_maptalks$CanvasLayer) {
    ...
    ThreeLayer.prototype.toExtrudeMesh = function toExtrudeMesh(polygon, amount, materials, removeDup) {
        var _this3 = this;
        ...
        if (polygon instanceof maptalks.MultiPolygon) {
            return polygon.getGeometries().map(function (c) {
                return _this3.toExtrudeGeometry(c, amount, materials);
            });
        }
        if (removeDup) {
        ...
        var geom = new THREE.ExtrudeGeometry(shape, { 'amount': amount, 'bevelEnabled': true,'material':1,'extrudeMaterial':0  });
